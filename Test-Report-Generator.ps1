        ...
        <div class="header-container">
            ...
            <div class="header-right">
                <div class="tenant-info" onclick="toggleHeaderDetails()">
                    <span class="subtitle">contoso.onmicrosoft.com</span>
                ...
                <div class="header-details-box" id="headerDetailsBox">
                    <div class="detail-item">
                        ...
                        <div class="detail-value">contoso.onmicrosoft.com</div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">Tenant ID</div>
                        <div class="detail-value">3d4143ab-9069-4b65-aac6-6b3e2e08f0ff</div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">Assessment generated by</div>
                        <div class="detail-value">$currentUser</div>
                    </div>
                    <div class="detail-item">
